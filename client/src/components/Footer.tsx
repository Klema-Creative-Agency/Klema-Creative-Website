...
export default function Footer() {
  return (
    <footer
      className="pt-10 sm:pt-14 pb-28 md:pb-14 border-t"
      style={{ background: "oklch(0.16 0.006 260)", borderColor: "oklch(1 0 0 / 0.08)" }}
    >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 mb-10 sm:mb-12">
          <div className="col-span-2">
            ...
            <p className="text-white/45 text-[0.8125rem] sm:text-[0.9375rem] leading-[1.6] sm:leading-[1.7] max-w-xs font-body">
              San Antonio's branding studio for the trades. Brands, vehicle wraps, and websites, designed and printed under one roof.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 sm:gap-2.5">
              {["Brand Identity", "Logo Design", "Vehicle Wraps", "Fleet Graphics", "Websites", "Print & Signage"].map((item) => (
                <a
                  key={item}
                  href="#services"
                  className="text-white/40 hover:text-white/70 text-[0.8125rem] sm:text-[0.875rem] transition-colors font-body py-1"
                >
                  {item}
                </a>
              ))}
