...
/** Archived Ignition tier - kept alive for /services/ai-lead-engine SEO value */
export const archivedIgnition: TierData = {
  slug: "ai-lead-engine",
  name: "Lead Engine",
  tierNumber: 0,
  price: "$997",
  ...
  roiCards: [
    ...
    { label: "With Lead Engine", value: "25-35% close", detail: "Instant response, automated follow-up, persistent nurturing. Every lead gets worked until they book or opt out." },
  ...
  metaTitle: "Lead Engine - Lead Conversion System for Service Businesses | Klema Creative",
  ...
  vslHeadline: "See How the Lead Engine Converts More of the Leads You Already Get",
...
export const tiers: TierData[] = [
  {
    ...
    includesPrevious: "Lead Engine (funnel, call trigger, SMS & email automation) is included.",
    stats: [
  ...
  },
  {
    ...
    deliverables: [
      ...
      { title: "Monthly Strategy Call", body: "Not a status update, but a working session where we review results, plan the next month, and adjust strategy based on real data." },
  ...
  },
  {
    ...
    deliverables: [
      ...
      { title: "Competitor Monitoring", body: "We track what your competitors are doing online, including their ads, their content, and their rankings, and we adjust your strategy to stay ahead." },
      ...
      { title: "Bi-Weekly Strategy Calls", body: "Not status updates, but working sessions where we plan the next 2 weeks based on data. Plus quarterly business reviews for the big picture." },
